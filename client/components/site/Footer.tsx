    ...
    <footer className="border-t bg-background/70">
      <div className="container py-8 text-center text-sm text-muted-foreground">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-center gap-x-3 gap-y-1">
          <span className="text-xs uppercase tracking-wide text-muted-foreground">Credits</span>
        ...
        <p className="mt-4 text-xs text-muted-foreground">© {new Date().getFullYear()} Charminar Family. All rights reserved.</p>
      </div>
    </footer>
  );
}
